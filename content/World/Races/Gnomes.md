...
- **Racial Features**:
	...
	- **Protection of Shadows.** You gain 1d4 to a saving throw when in darkness or dim light. You can use this feature number of times equal to your proficiency bonus.
	...
	- **Scrapwork.** You create a small, handheld contraption with an effect chosen from the list below. It takes 5 minutes to prepare a contraption and you can create one contraption per long rest if you have materials to do so. At maximum, the number of contraptions that you have currently created is equivalent to your proficiency bonus. After using the contraption, it is destroyed. 
		...
		- **Improvised trap** As an action you can place an improvised trap (trip wire, trapped door, pressure plate...). The check for someone else's attempt to discover or disable the trap is equal to 8 + Intelligence + Proficiency bonus. Upon activation a loud ringing noise is heard within 60 feet or another trap is activated.
- **Society and culture** While originating from subterranean dwellings, these Gnomes have largely transitioned to surface life over generations. Though their eyes retain a sensitivity that makes bright, direct sunlight uncomfortable, they have adapted and thrived.
...
- **Physiology** Gnomes are lean with surprisingly strong hands and nimble fingers perfect for manipulating delicate instruments. Their most striking feature is their large eyes, adapted for the low light of their subterranean homes. Irises often come in deep, muted colors like slate grey, midnight blue, amethyst purple, or even metallic copper or silver, sometimes appearing to subtly shift hue in changing light.
  Their skin tones range from earthy browns and deep greys, reminiscent of the stone they live amongst, to paler, almost luminescent shades. Some bloodlines exhibit faint, intricate patterns on their skin, which might pulse with faint light in complete darkness. Their origin and purpose is currently unknown. Hair is typically dark (black, deep brown, grey) but can sometimes have metallic sheens or even a crystalline texture, often kept practically short or intricately braided and pinned with mechanical clasps.
- **Religion** Gnomish faith mirrors their societal values, focusing on deities that embody creation, craftsmanship, knowledge, the earth, and order.
- **Language** Gnomes speak Common, necessary for trade and interaction with surface dwellers. They also have their own language, Gnomish, which shares script with the Dwarven language.
