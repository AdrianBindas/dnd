...
2. Each character gains free feat at the 1st level.
3. Power attack for everyone:
   When you use the attack action to make an attack using a weapon you are proficient with or an unarmed strike, you can choose to take (- Proficiency bonus) penalty to the attack roll and (Proficiency bonus x 2) to the attack's damage. These bonuses do not stack with bonuses granted by the [Great Weapon Master](https://dnd5e.wikidot.com/feat:great-weapon-master) or [Sharpshooter](https://dnd5e.wikidot.com/feat:sharpshooter) feats.
4. [Shield](https://dnd5e.wikidot.com/spell:shield) spell offers only +3 bonus to AC (from +5).
5. Do not roll for stats at character creation. Use point buy or standard array.
6. Choose only from species found in the [[List of species]].